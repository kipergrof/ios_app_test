...
import 'package:flutter_test1/utils/extensions.dart';
...
class EspProv {
  ...
  Future<Uint8List> sendReceiveElvlData(Uint8List data,
    ...
    while (i > 0) {
      ...
      var newData = await transport!.sendReceive('elvl', needToSend);
